function main()
{
  ...
  // Yellow cylinders
  var yellowCylinderGeometry = new THREE.CylinderGeometry(0.07, 0.07, 1.0, 25);
  var yellowCylinderMaterial = new THREE.MeshPhongMaterial({ color:'rgb(255,255,100)'} );
  ...
  function rotateCylinder()
  {
    ...
    if(animationOn)
    {
      ...
      yellowCylinder1.matrix.identity();
      yellowCylinder2.matrix.identity();
      ...
      // Yellow cylinder1
      yellowCylinder1.matrix.multiply(mat4.makeRotationY(angle3));
      yellowCylinder1.matrix.multiply(mat4.makeTranslation(0.0, 0.5, 0.0));
      yellowCylinder1.matrix.multiply(mat4.makeRotationX(degreesToRadians(90)));

      // Yellow cylinder2
      yellowCylinder2.matrix.multiply(mat4.makeRotationY(-angle3));
      yellowCylinder2.matrix.multiply(mat4.makeTranslation(0.0, -0.5, 0.0));
      yellowCylinder2.matrix.multiply(mat4.makeRotationX(degreesToRadians(90)));
    }
  }
